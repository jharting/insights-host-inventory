...
class Config:
    ...
    def clowder_config(self):
        ...
        self.workspaces_bulk_topic = topic(os.environ.get("KAFKA_WORKSPACES_BULK_TOPIC"))
    ...
    def non_clowder_config(self):
        ...
        self.workspaces_bulk_topic = os.environ.get("KAFKA_WORKSPACES_BULK_TOPIC", "outbox.event.workspace-bulk")
    ...
    def __init__(self, runtime_environment):
        ...
        self.outbox_use_batched_queries = os.environ.get("OUTBOX_USE_BATCHED_QUERIES", "false").lower() == "true"
